...
напишем игру Угадай число пользователь вводит максимальный потолок значений
например 1000 компьютер загадывает число
напишите три разных алгоритма поиска этого числа, оценить их сложность'''
import random
import time
